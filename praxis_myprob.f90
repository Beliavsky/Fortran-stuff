module praxis_prob_mod
! 09/22/2018 05:38 PM put procedures in modules
! 09/22/2018 05:36 PM branched from praxis_prb.f90
use praxis_mod
public
contains
...
!  real ( kind = 8 ) praxis
  ...
  return
end subroutine rosenbrock_test
!
...
!  real ( kind = 8 ) praxis
  ...
  return
end subroutine tridiagonal_test
!
...
! call random_number ( harvest = d(1:n) )
  ...
  return
end subroutine svsort_test
end module praxis_prob_mod
